...
glslc %ROOT_PATH%/shaders/rain_drops_inst.vert -o %ROOT_PATH%/shaders/rain_drops_inst_vs.spv
...
glslc %ROOT_PATH%/shaders/splash.comp -o %ROOT_PATH%/shaders/splash_cp.spv

rem glslc doesn't support mesh shaders yet
